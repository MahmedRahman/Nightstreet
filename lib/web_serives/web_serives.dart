...
class WebServices {
  ...
  Future<ResponseModel> getProductsByMarketId({
    ...
    String url =
        '${ApiConfig.baseUrl}/products/get?market_id=${id}&page=${page}';
  ...
  Future<ResponseModel> getAvailableOfferTimes({
    ...
    if (doctorId == "null" || doctorId == "0" || doctorId == "") {
      return await ApiManger().execute(
        url:
...
//
  ...
  Future<ResponseModel> getOffersByBranchesId({
    ...
    return await ApiManger().execute(
      url:
          "${ApiConfig.baseUrl}/offers/get?branch_id=$branchesId&page=$page&not_featured=$notFeatured&featured=$featured",
      HTTPRequestMethod: HTTPRequestEnum.GET,
      isAuth: true,
    );
  }
...
//   }
  ...
  Future<ResponseModel> getMaretDate({
    required String marketId,
  }) async {
    return await ApiManger().execute(
      url: "${ApiConfig.baseUrl}/products/single-market?id=$marketId",
      HTTPRequestMethod: HTTPRequestEnum.GET,
      isAuth: true,
    );
  }

  Future<ResponseModel> getHomesSliderSetting(String sliderType) async {
    return await ApiManger().execute(
      url: "${ApiConfig.baseUrl}/setting/slider?type=${sliderType}",
      HTTPRequestMethod: HTTPRequestEnum.GET,
      isAuth: true,
    );
  }
  ...
  Future<ResponseModel> getAvailableOfferDays(
      {offerId, branchId, doctorId}) async {
    if (doctorId == "null") {
      return await ApiManger().execute(
        url:
            "${ApiConfig.baseUrl}/appointments/get-available-offer-days?offer_id=${offerId}&branch_id=${branchId}",
        HTTPRequestMethod: HTTPRequestEnum.GET,
        isAuth: true,
      );
    }
    ...
    return await ApiManger().execute(
      url:
          "${ApiConfig.baseUrl}/appointments/get-available-offer-days?offer_id=${offerId}&branch_id=${branchId}&doctor_id=${doctorId}",
      HTTPRequestMethod: HTTPRequestEnum.GET,
      isAuth: true,
    );
  }
