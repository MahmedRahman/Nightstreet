...
import 'package:krzv2/app/modules/order_review/views/order_review_view.dart';
                ...
                children: [
                  Expanded(
                    child: CustomBtnCompenent.main(
                      text: 'اعادة الطلب',
                      onTap: () => controller.reOrder(orderId: order.id),
                    ),
                  ),
                  AppSpacers.width20,
                  Expanded(
                    child: InkWell(
                      onTap: () {
                        AppDialogs.showToast(message: 'تحت الانشاء');
                      },
